...
class GenerateCpfCommand3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:generatecpf3';
...
//        $cpf = '11637563779';
        ...
        if ($this->validaCPF($cpf)) {
            ...
            if ($carbonDataVerificar->between(Carbon::parse('1970-01-01'), Carbon::parse('1989-12-31'))) {
